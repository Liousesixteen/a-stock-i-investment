...
- Market sentiment, 情绪评分, 最新新闻, 利好利空, 小道消息, 外围/国内影响, risk appetite: run `sentiment --live`; explain the multi-factor breakdown across index performance, liquidity, northbound flow, sector diffusion, theme heat, and news. Use only real sources and report missing data instead of inventing fallback data.
